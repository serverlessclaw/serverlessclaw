      ...
      <header className="flex flex-col lg:flex-row lg:justify-between lg:items-end border-b border-white/5 pb-6 gap-6">
        ...
        <div className="flex gap-4 items-end">
          ...
          <div className="flex flex-col items-center text-center">
            <Typography variant="mono" color="muted" className="text-[10px] uppercase tracking-widest opacity-40 mb-1">PAGE_RESULTS</Typography>
            ...
            <div className="relative z-10 space-y-4">
              <div className="flex justify-between items-start">
                ...
                <div className="flex items-center gap-2">
                  <ExportButton sessionId={session.sessionId} sessionTitle={session.title || 'Untitled Conversation'} />
                  {session.isPinned && (
              ...
              <div>
                ...
                <Typography variant="mono" color="muted" className="text-[10px] block mt-1 opacity-50 line-clamp-1">
