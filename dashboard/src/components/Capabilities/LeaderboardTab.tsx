...
export default function LeaderboardTab({ allTools, optimisticAgents, searchQuery = '' }: LeaderboardTabProps) {
          ...
          <table className="w-full text-left border-collapse min-w-[600px]">
            ...
            <tbody>
              ...
              {filteredTools.length === 0 && (
                <tr>
                  <td colSpan={4} className="p-10 text-center text-white/20 italic text-xs tracking-widest">
