...
import {
  MessageSquare, Wrench, CheckCircle, ShieldAlert, Code, Terminal, Brain, X,
  HelpCircle, Pause, Play, Layers, GitBranch, Shield, Cpu
} from 'lucide-react';
  ...
  return (
    <div className="absolute top-4 right-4 bottom-4 w-96 bg-[#0a0f1a]/95 border border-cyber-green/30 shadow-[0_0_30px_rgba(0,255,163,0.1)] z-50 rounded-lg flex flex-col animate-in slide-in-from-right-10 duration-300">
      ...
      <div className="flex-1 overflow-y-auto p-4 custom-scrollbar space-y-4">
        ...
        {selectedStep.type === TRACE_TYPES.LLM_CALL && (selectedStep as TraceStep).content?.messages && (
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              {(selectedStep as TraceStep).content?.messages?.map((msg: { role: string; content: string }, idx: number) => (
