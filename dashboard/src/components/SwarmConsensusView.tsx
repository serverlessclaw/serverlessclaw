    ...
    <div className="space-y-10">
          ...
          >
              ...
              <div className="bg-foreground/5 border border-border p-6 rounded-2xl min-w-[240px] text-center space-y-4">
                ...
                <div className="relative w-32 h-32 mx-auto">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <Typography variant="h3" className="font-black leading-none">
                      {yesPercent.toFixed(0)}%
                    </Typography>
                    <Typography variant="mono" className="text-[10px] uppercase opacity-40 mt-1">
                      APPROVAL
                    </Typography>
                  </div>
                </div>
                <div className="flex justify-center gap-4 border-t border-foreground/5 pt-4">
                  <div className="text-center">
                    ...
                    <Typography
                      variant="mono"
                      className="text-[9px] uppercase opacity-40 font-bold"
                    >
                      YES
                    </Typography>
                  </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 opacity-40 px-2">
                <Vote size={14} />
                <Typography variant="mono" className="text-xs uppercase tracking-widest font-black">
                  Audit Trail (Agent Votes)
                </Typography>
              </div>
                  ...
                  >
                    <div className="flex justify-between items-center mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <Typography
                          variant="mono"
                          className="text-xs font-bold uppercase truncate w-24"
                        >
                          {vote.agentId}
                        </Typography>
                      </div>
                    ...
                    <div className="mt-3 flex items-center gap-2 border-t border-foreground/5 pt-3">
                      ...
                      <Typography
                        variant="mono"
                        className="text-[10px] text-cyber-blue/40 uppercase tracking-tighter"
                      >
                        Reputation: {(vote.reputation * 100).toFixed(0)}
                      </Typography>
                    </div>
                  </div>
                ))}
      ...
      {requests.length === 0 && (
        <div className="py-32 flex flex-col items-center justify-center text-center space-y-6 bg-foreground/[0.01] border border-dashed border-border rounded-2xl animate-in fade-in zoom-in duration-700">
          ...
          <div>
            <Typography variant="h3" uppercase glow className="tracking-widest">
              Consensus Archive Clear
            </Typography>
            <Typography
              variant="body"
              color="muted"
              className="mt-2 text-xs uppercase tracking-[0.2em] opacity-50"
            >
